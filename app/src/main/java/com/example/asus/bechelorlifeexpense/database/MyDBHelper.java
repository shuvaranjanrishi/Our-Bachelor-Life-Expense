...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = " CREATE TABLE "+TABLE_NAME+"("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+EXPENSE_TYPE+" TEXT, "+EXPENSE_AMOUNT+" TEXT, "+EXPENSE_DATE+" TEXT, "+EXPENSE_TIME+" TEXT,"+SPENDER_NAME+" TEXT, "+CONSUMER_NAME+" TEXT )";
    ...
    public long insertDataToDatabase(String expenseType,String expenseAmount,String expenseDate,String expenseTime,String spenderName,String consumerName){
    ...
    public long updateDataToDatabase(String id,String expenseType, String expenseAmount,String expenseDate,String expenseTime,String spenderName,String consumerName){
